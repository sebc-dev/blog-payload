...
describe('Categories - Tests unitaires des hooks et validations', () => {
  ...
  describe('Validation du slug', () => {
    ...
    it('devrait rejeter des slugs avec des caractères majuscules', () => {
      expect(validateSlug('Technology')).toBe(
        'Le slug doit contenir uniquement des lettres minuscules, chiffres et tirets',
      )
      expect(validateSlug('WEB-DEVELOPMENT')).toBe(
        'Le slug doit contenir uniquement des lettres minuscules, chiffres et tirets',
      )
    })
    ...
    it('devrait rejeter des slugs avec des espaces', () => {
      ...
      expect(validateSlug('machine learning')).toBe(
        'Le slug doit contenir uniquement des lettres minuscules, chiffres et tirets',
      )
    })

    it('devrait rejeter des slugs avec des caractères spéciaux', () => {
      expect(validateSlug('web_development')).toBe(
        'Le slug doit contenir uniquement des lettres minuscules, chiffres et tirets',
      )
      expect(validateSlug('node.js')).toBe(
        'Le slug doit contenir uniquement des lettres minuscules, chiffres et tirets',
      )
      expect(validateSlug('react@framework')).toBe(
        'Le slug doit contenir uniquement des lettres minuscules, chiffres et tirets',
      )
      expect(validateSlug('vue/js')).toBe(
        'Le slug doit contenir uniquement des lettres minuscules, chiffres et tirets',
      )
    })
  ...
  describe('Tests spécifiques de la regex de validation du slug', () => {
    ...
    it('devrait accepter des slugs qui respectent strictement la regex', () => {
      const validSlugs = [
        ...
        'web-dev',
        'machine-learning',
        'data-science', // mots avec tirets
        'a-b-c-d-e',
        'word1-word2-word3', // chaînes de mots
        'tech2024',
        'web3-development',
        '123-abc-456', // mixte lettres/chiffres
      ]
    ...
    it('devrait rejeter des slugs avec des caractères interdits par la regex', () => {
      const invalidSlugs = [
        ...
        'web dev',
        'machine learning', // espaces
        'web.dev',
        'node.js', // points
        'react@vue',
        'web+dev', // caractères spéciaux
        'développement',
        'créativité', // accents (même si pas dans le code source)
        'C++',
        'C#',
        'F#', // caractères de programmation
        'web/dev',
        'api\\rest', // slashes
        'data:science',
        'web;dev', // deux-points, point-virgule
        'web[dev]',
        'api{rest}',
        '(test)', // parenthèses, crochets
        'hello!',
        'test?',
        'end.', // ponctuation
        'café',
        'naïve',
        'résumé', // caractères non-ascii
      ]
